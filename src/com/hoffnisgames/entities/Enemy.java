...
public class Enemy extends Entity {
	...
	public void tick() {
		...
		followPath(path);
			...
			if(life <= 0) {
				Game.player.score= Game.player.score+15;
				destroySelf();
				return;
			}
		...
		for(int i = 0; i < Game.bullets.size(); i++) {
			Entity e = Game.bullets.get(i);	
				if(Entity.isCollinding(this, e)) {
					...
					Particle.pcolor = 2;
					World.genparticle(77,(int) x, (int)y);
					return;
				}
		...
		for(int i = 0; i < Game.bull.size(); i++) {
			Entity e = Game.bull.get(i);	
				if(Entity.isCollinding(this, e)) {
					...
					Particle.pcolor = 2;
					World.genparticle(120,(int) x, (int)y);
					//Game.bull.remove(i);
					return;
					}
	...
	public void render(Graphics g) {
		...
		g.drawImage(sprites[index], this.getX()-Camera.x, this.getY()-Camera.y, null);
			...
			g.drawImage(Entity.ENEMY_FEED, this.getX()-Camera.x, this.getY()-Camera.y, null);
